...
<head>
    ...
    <title>Delivery Man Dashboard | Kenakata</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .content-card h2 { font-size: 28px; font-weight: 800; color: #4ade80; margin-bottom: 12px; }
...
<div class="page">
    ...
    <div class="content-card">
        <h2>Welcome to the Delivery Dashboard</h2>
        <p>This is the dashboard of Delivery Man ({{ $deliveryman->DelManName }}).</p>
    </div>
</div>
